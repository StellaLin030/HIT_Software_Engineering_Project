  ...
  <div>
    ...
    <div class="retrieve-page">
      <div class="retrieve-container">
        ...
        <form @submit.prevent="retrieve" class="retrieve-form">
          ...
          <button type="submit" class="retrieve-button">找回密码</button>
        </form>
        <p class="retrieve-message">{{ message }}</p>
        <p>还记得密码？ <router-link to="/login">点击这里登录</router-link></p>
      </div>
    </div>
  </div>
</template>
